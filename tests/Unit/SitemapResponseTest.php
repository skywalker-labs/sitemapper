...
test('SitemapResponse creates valid PSR-7 response', function () {
    ...
    $response = new class implements ResponseInterface {
        public $headers = [];
        public $body;
        public function withHeader(string $name, $value): ResponseInterface { $this->headers[$name] = $value; return $this; }
        public function withBody(StreamInterface $body): ResponseInterface { $this->body = $body; return $this; }
    ...
    $responseFactory = new class($response) implements ResponseFactoryInterface {
        ...
        public function createResponse(int $code = 200, string $reasonPhrase = ''): ResponseInterface { return $this->res; }
    };
    ...
    $streamFactory = new class implements StreamFactoryInterface {
        ...
        public function createStreamFromFile(string $filename, string $mode = 'r'): StreamInterface { throw new Exception(); }
        public function createStreamFromResource($resource): StreamInterface { throw new Exception(); }
    };
